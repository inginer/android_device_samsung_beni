...
PRODUCT_COPY_FILES += \
    ...
    device/samsung/beni/prebuilt/gps.msm7k.so:system/vendor/lib/hw/gps.msm7k.so \
    device/samsung/beni/prebuilt/gps.msm7k.so:system/lib/hw/gps.msm7k.so \
    device/samsung/beni/prebuilt/gps.beni.so:system/lib/hw/gps.beni.so \
    device/samsung/beni/prebuilt/lights.msm7k.so:system/lib/hw/lights.msm7k.so \
...
## 3D
PRODUCT_COPY_FILES += \
    device/samsung/beni/prebuilt/libGLESv1_CM_adreno200.so:system/lib/egl/libGLESv1_CM_adreno200.so \
    device/samsung/beni/prebuilt/libq3dtools_adreno200.so:system/lib/egl/libq3dtools_adreno200.so \
    device/samsung/beni/prebuilt/libEGL_adreno200.so:system/lib/egl/libEGL_adreno200.so \
    device/samsung/beni/prebuilt/libGLESv2_adreno200.so:system/lib/egl/libGLESv2_adreno200.so \
    device/samsung/beni/prebuilt/libgsl.so:system/lib/libgsl.so \
    device/samsung/beni/prebuilt/egl.cfg:system/lib/egl/egl.cfg 

## GPU firmware
PRODUCT_COPY_FILES += \
    device/samsung/beni/prebuilt/yamato_pm4.fw:system/etc/firmware/yamato_pm4.fw \
    device/samsung/beni/prebuilt/yamato_pfp.fw:system/etc/firmware/yamato_pfp.fw
...
PRODUCT_COPY_FILES += \
 ...
 PRODUCT_COPY_FILES += \
	device/samsung/beni/prebuilt/gralloc.beni.so:system/lib/hw/gralloc.beni.so \
	device/samsung/beni/prebuilt/hwcomposer.beni.so:system/lib/hw/hwcomposer.beni.so \



## Prebuilt App
PRODUCT_COPY_FILES += \
    device/samsung/beni/prebuilt/UsbMassStorageToggle.apk:system/app/UsbMassStorageToggle.apk
